...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"ingresscoinaddress\"\n"
            "\nReturn information about the given ingresscoin address.\n"
            "\nArguments:\n"
            "1. \"ingresscoinaddress\"     (string, required) The ingresscoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"ingresscoinaddress\", (string) The ingresscoin address validated\n"
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are ingresscoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) ingresscoin address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"ingresscoinaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"ingresscoinaddress\"  (string, required) The ingresscoin address to use for the signature.\n"
